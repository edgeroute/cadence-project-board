...
const ItemModal = ({ item, fields, busy, error, projectPath, onSetField, onClose }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-overlay", onClick: onClose, role: "presentation" }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cpb-body" }, /* @__PURE__ */ React.createElement(RichText, { text: content.body })), (content == null ? void 0 : content.id) && projectPath && /* @__PURE__ */ React.createElement(Comments, { issueId: content.id, knownCount: content.comments, projectPath }), content && /* @__PURE__ */ React.createElement("a", { className: "cpb-open-link", href: content.url, target: "_blank", rel: "noreferrer noopener" }, "Open on GitHub ↗"))
  ));
};
...
const App = () => {
  ...
  ), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn", onClick: () => void load(true), disabled: loading }, loading ? "Loading…" : "Refresh"), board && /* @__PURE__ */ React.createElement("a", { className: "cpb-btn", href: board.url, target: "_blank", rel: "noreferrer noopener" }, "GitHub ↗"), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn", onClick: () => void openSettings(), "aria-label": "Board settings" }, "⚙"))), error && /* @__PURE__ */ React.createElement("div", { className: "cpb-error cpb-error--bar", role: "alert" }, /* @__PURE__ */ React.createElement("span", null, error), /* @__PURE__ */ React.createElement("button", { className: "cpb-error-dismiss", onClick: () => setError(""), "aria-label": "Dismiss" }, "✕")), notConfigured ? /* @__PURE__ */ React.createElement("div", { className: "cpb-setup" }, /* @__PURE__ */ React.createElement("h2", { className: "cpb-setup-title" }, "No board yet"), /* @__PURE__ */ React.createElement("p", { className: "cpb-setup-body" }, notConfigured), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn cpb-btn--primary", onClick: () => void openSettings() }, "Set up the board")) : loading && !board ? /* @__PURE__ */ React.createElement("div", { className: "cpb-setup" }, /* @__PURE__ */ React.createElement("p", { className: "cpb-setup-body" }, "Loading the board…")) : board ? /* @__PURE__ */ React.createElement(
    Board,
    {
      board,
      items: filtered,
