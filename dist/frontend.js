...
const PluginProvider = ({ api, children }) => /* @__PURE__ */ React.createElement(Ctx.Provider, { value: api }, children);
function usePluginAPI() {
  const api = reactExports.useContext(Ctx);
...
function useProjectPath() {
  ...
  const [path, setPath] = React.useState(((_a = api.context.project) == null ? void 0 : _a.path) ?? null);
  React.useEffect(() => {
    return api.onContextChange(() => {
      var _a2;
      return setPath(((_a2 = api.context.project) == null ? void 0 : _a2.path) ?? null);
    });
  }, [api]);
  return path;
}
function useTheme() {
  const api = usePluginAPI();
  const [theme, setTheme] = React.useState(api.context.theme);
  React.useEffect(() => {
    return api.onContextChange(() => setTheme(api.context.theme));
  }, [api]);
  return theme;
}
function isNotConfigured(r2) {
  return r2.notConfigured === true;
}
...
function columnIdFor(item, statusFieldId) {
  if (!statusFieldId) return NO_STATUS;
  return item.singleSelect[statusFieldId] ?? NO_STATUS;
}
function itemTitle(item) {
  var _a;
  return ((_a = item.content) == null ? void 0 : _a.title) ?? item.draftTitle ?? "Untitled";
}
function itemMatches(item, query) {
  const q2 = query.trim().toLowerCase();
  if (!q2) return true;
  const c = item.content;
  if (c && (`#${c.number}`.includes(q2) || String(c.number) === q2)) return true;
  if (c && c.repository.toLowerCase().includes(q2)) return true;
  return itemTitle(item).toLowerCase().includes(q2);
}
const PRIORITY_TINT = {
  P0: "#ef4444",
  P1: "#f59e0b",
...
function optionName(item, fields, fieldName) {
  var _a;
  const field = fieldByName(fields, fieldName);
  if (!field) return null;
  const optionId = item.singleSelect[field.id];
  if (!optionId) return null;
  return ((_a = field.options.find((o) => o.id === optionId)) == null ? void 0 : _a.name) ?? null;
}
function labelTextColor(hex) {
  const m2 = /^#?([0-9a-f]{6})$/i.exec(hex);
  if (!m2) return "#000";
  const n2 = parseInt(m2[1], 16);
  const lum = 0.299 * (n2 >> 16 & 255) + 0.587 * (n2 >> 8 & 255) + 0.114 * (n2 & 255);
  return lum > 140 ? "#000" : "#fff";
}
const Card = ({ item, columnId, fields, busy, onOpen }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cpb-card-top" }, content ? /* @__PURE__ */ React.createElement("span", { className: "cpb-card-number" }, "#", content.number) : /* @__PURE__ */ React.createElement("span", { className: "cpb-card-draft" }, "DRAFT"), priority && /* @__PURE__ */ React.createElement(
      "span",
      {
      ...
      priority
    ), size && /* @__PURE__ */ React.createElement("span", { className: "cpb-card-size" }, size), busy && /* @__PURE__ */ React.createElement("span", { className: "cpb-card-spinner", "aria-label": "Saving" })),
    /* @__PURE__ */ React.createElement("div", { className: "cpb-card-title" }, itemTitle(item)),
    content && (content.labels.length > 0 || content.assignees.length > 0) && /* @__PURE__ */ React.createElement("div", { className: "cpb-card-bottom" }, /* @__PURE__ */ React.createElement("div", { className: "cpb-card-labels" }, content.labels.slice(0, 3).map((l2) => /* @__PURE__ */ React.createElement(
      "span",
      {
        key: l2.name,
        className: "cpb-card-label",
        style: { background: `#${l2.color}`, color: labelTextColor(l2.color) }
      },
      l2.name
    ))), /* @__PURE__ */ React.createElement("div", { className: "cpb-card-avatars" }, content.assignees.slice(0, 3).map((a) => /* @__PURE__ */ React.createElement("img", { key: a.login, className: "cpb-card-avatar", src: a.avatarUrl, alt: a.login, title: a.login }))))
  );
};
const Column = ({
  column,
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "cpb-column-name" }, collapsed ? "" : column.name),
      /* @__PURE__ */ React.createElement("span", { className: "cpb-column-count" }, items.length),
      /* @__PURE__ */ React.createElement("span", { className: "cpb-column-chev" }, collapsed ? "▸" : "▾")
    ),
    collapsed ? /* @__PURE__ */ React.createElement("button", { className: "cpb-column-collapsed", onClick: onToggle }, /* @__PURE__ */ React.createElement("span", { className: "cpb-column-collapsed-label" }, column.name)) : /* @__PURE__ */ React.createElement("div", { className: "cpb-column-body" }, items.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: `cpb-column-empty${dragOver ? " cpb-column-empty--over" : ""}` }, dragOver ? "↓ Drop here" : "Nothing here") : items.map((item) => /* @__PURE__ */ React.createElement(
      Card,
      {
        key: item.id,
        item,
...
function useIsNarrow() {
  const q2 = `(max-width: ${MOBILE_MAX}px)`;
  const [narrow, setNarrow] = React.useState(
    () => typeof window !== "undefined" && window.matchMedia(q2).matches
  );
  React.useEffect(() => {
    if (typeof window === "undefined") return;
    const mql = window.matchMedia(q2);
...
const Board = ({
  ...
  const byColumn = React.useMemo(() => {
    ...
    for (const item of items) {
      const id2 = columnIdFor(item, (statusField == null ? void 0 : statusField.id) ?? null);
      const bucket = map.get(id2) ?? map.get(NO_STATUS);
      bucket == null ? void 0 : bucket.push(item);
    }
    return map;
  ...
  const visible = columns.filter(
    (c) => {
      var _a;
      return c.id !== NO_STATUS || !statusField || (((_a = byColumn.get(NO_STATUS)) == null ? void 0 : _a.length) ?? 0) > 0;
    }
  );
  const inGrid = narrow ? visible.filter((c) => !collapsed.has(c.id)) : visible;
  const chips = narrow ? visible.filter((c) => collapsed.has(c.id)) : [];
  const gridTemplate = inGrid.map((c) => collapsed.has(c.id) ? "44px" : "minmax(220px, 1fr)").join(" ");
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-board-wrap" }, chips.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "cpb-chips" }, chips.map((c) => {
    var _a;
    return /* @__PURE__ */ React.createElement("button", { key: c.id, className: "cpb-chip", onClick: () => onToggleColumn(c.id) }, c.name, /* @__PURE__ */ React.createElement("span", { className: "cpb-chip-count" }, ((_a = byColumn.get(c.id)) == null ? void 0 : _a.length) ?? 0));
  })), /* @__PURE__ */ React.createElement("div", { className: "cpb-board", style: { gridTemplateColumns: gridTemplate } }, inGrid.map((c) => /* @__PURE__ */ React.createElement(
    Column,
    {
      key: c.id,
      column: c,
...
const Comments = ({ issueId, knownCount, projectPath }) => {
  const api = usePluginAPI();
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      ...
      setError(e.message || "Could not load the comments.");
    }
  ...
  const post = async () => {
    ...
    try {
      ...
      window.setTimeout(() => {
        var _a;
        return (_a = endRef.current) == null ? void 0 : _a.scrollIntoView({ block: "nearest" });
      }, 0);
    } catch (e) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-comments" }, /* @__PURE__ */ React.createElement("div", { className: "cpb-field-name" }, count === 0 ? "Comments" : `Comments · ${count}`, comments === null && !error && /* @__PURE__ */ React.createElement("span", { className: "cpb-comments-loading" }, " loading…")), error && /* @__PURE__ */ React.createElement("div", { className: "cpb-error", role: "alert" }, error), comments !== null && comments.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "cpb-comments-empty" }, "No comments yet."), comments !== null && comments.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "cpb-comment-list" }, comments.map((c) => {
    ...
    "textarea",
    {
      ...
      onPasteCapture: (e) => {
        ...
        const start = el2.selectionStart ?? draft.length;
        const end = el2.selectionEnd ?? draft.length;
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "cpb-composer-actions" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-hint" }, "⌘/Ctrl + Enter to post"), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn cpb-btn--primary", onClick: () => void post(), disabled: !draft.trim() || posting }, posting ? "Posting…" : "Comment"))));
};
const GitHubMark = ({ size = 14 }) => /* @__PURE__ */ React.createElement("svg", { width: size, height: size, viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true", focusable: "false" }, /* @__PURE__ */ React.createElement("path", { d: "M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z" }));
const FieldRow = ({ field, currentId, disabled, onPick }) => /* @__PURE__ */ React.createElement("div", { className: "cpb-field" }, /* @__PURE__ */ React.createElement("div", { className: "cpb-field-name" }, field.name), /* @__PURE__ */ React.createElement("div", { className: "cpb-field-options" }, field.options.map((o) => /* @__PURE__ */ React.createElement(
  "button",
  {
    key: o.id,
  ...
  o.name
)), currentId && /* @__PURE__ */ React.createElement("button", { className: "cpb-opt cpb-opt--clear", disabled, onClick: () => onPick(null) }, "Clear")));
const ItemModal = ({ item, fields, busy, error, projectPath, onSetField, onClose }) => {
  const content = item.content;
  React.useEffect(() => {
    const onKey = (e) => {
  ...
  const rows = [STATUS_FIELD, PRIORITY_FIELD, SIZE_FIELD].map((name) => fieldByName(fields, name)).filter((f) => f !== null);
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-overlay", onClick: onClose, role: "presentation" }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-head" }, /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-titles" }, /* @__PURE__ */ React.createElement("h2", { className: "cpb-modal-title" }, itemTitle(item)), content && /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-sub" }, content.repository, " · #", content.number, " · ", content.state.toLowerCase(), content.comments > 0 && ` · ${content.comments} comment${content.comments === 1 ? "" : "s"}`)), content && /* @__PURE__ */ React.createElement(
      "a",
      {
      ...
      /* @__PURE__ */ React.createElement(GitHubMark, null)
    ), /* @__PURE__ */ React.createElement("button", { className: "cpb-close", onClick: onClose, "aria-label": "Close" }, "✕")),
    /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-scroll" }, error && /* @__PURE__ */ React.createElement("div", { className: "cpb-error", role: "alert" }, error), /* @__PURE__ */ React.createElement("div", { className: "cpb-fields" }, rows.map((f) => /* @__PURE__ */ React.createElement(
      FieldRow,
      {
        key: f.id,
        field: f,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cpb-body" }, /* @__PURE__ */ React.createElement(RichText, { text: content.body })), (content == null ? void 0 : content.id) && projectPath && /* @__PURE__ */ React.createElement(Comments, { issueId: content.id, knownCount: content.comments, projectPath }))
  ));
};
...
const SettingsModal = ({ initial, saving, error, onSave, onClose }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-overlay", onClick: onClose, role: "presentation" }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-scroll" }, error && /* @__PURE__ */ React.createElement("div", { className: "cpb-error", role: "alert" }, error), clipboardNote && /* @__PURE__ */ React.createElement("div", { className: "cpb-error", role: "alert" }, clipboardNote), /* @__PURE__ */ React.createElement("label", { className: "cpb-label", htmlFor: "cpb-url" }, "Project URL"), /* @__PURE__ */ React.createElement("div", { className: "cpb-input-row" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        id: "cpb-url",
        className: "cpb-input",
    ...
    ), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn cpb-paste", onClick: () => void pasteFromClipboard(setUrl, { detectUrl: true }), title: "Paste from clipboard" }, "Paste")), /* @__PURE__ */ React.createElement("div", { className: "cpb-hint" }, "Paste it and the two fields below fill themselves in."), /* @__PURE__ */ React.createElement("div", { className: "cpb-row2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cpb-label", htmlFor: "cpb-owner" }, "Owner"), /* @__PURE__ */ React.createElement(
      "input",
      {
        id: "cpb-owner",
        className: "cpb-input",
    ...
    ))), /* @__PURE__ */ React.createElement("label", { className: "cpb-label", htmlFor: "cpb-token" }, "GitHub token", initial.tokenSource === "config" && /* @__PURE__ */ React.createElement("span", { className: "cpb-tag" }, "saved"), initial.tokenSource === "env" && /* @__PURE__ */ React.createElement("span", { className: "cpb-tag" }, "from GH_TOKEN")), /* @__PURE__ */ React.createElement("div", { className: "cpb-input-row" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        id: "cpb-token",
        className: "cpb-input",
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "cpb-hint" }, "Defaults to ", /* @__PURE__ */ React.createElement("code", null, initial.aiModel), ". A cheaper model will cost less and judge less well; because these suggestions become writes to a shared board, that trade is yours to make rather than one this plugin makes for you."), /* @__PURE__ */ React.createElement("div", { className: "cpb-actions" }, /* @__PURE__ */ React.createElement("button", { className: "cpb-btn", onClick: onClose, disabled: saving }, "Cancel"), /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        onClick: () => onSave({
          ...
          anthropicKey: anthropicKey.trim() || void 0,
          aiModel: aiModel.trim() || void 0
        })
      },
      saving ? "Saving…" : "Save"
    )))
...
const NO_FILTERS = { priority: "", size: "" };
function hasFilters(f) {
  return f.priority !== "" || f.size !== "";
}
const FieldFilter = ({ field, value, onChange }) => /* @__PURE__ */ React.createElement("div", { className: "cpb-filter-group", role: "group", "aria-label": `Filter by ${field.name}` }, /* @__PURE__ */ React.createElement("span", { className: "cpb-filter-label" }, field.name), /* @__PURE__ */ React.createElement(
  "button",
  {
  ...
  "All"
), field.options.map((o) => /* @__PURE__ */ React.createElement(
  "button",
  {
    key: o.id,
...
const FilterBar = ({ fields, filters, onChange }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-filters" }, priority && /* @__PURE__ */ React.createElement(
    FieldFilter,
    {
      field: priority,
  ...
  ), size && /* @__PURE__ */ React.createElement(FieldFilter, { field: size, value: filters.size, onChange: (next) => onChange({ ...filters, size: next }) }), hasFilters(filters) && /* @__PURE__ */ React.createElement("button", { className: "cpb-filter cpb-filter--clear", onClick: () => onChange(NO_FILTERS) }, "Clear filters"));
};
function passesFilter(singleSelect, field, value) {
  if (!value || !field) return true;
  const current = singleSelect[field.id];
  if (value === UNSET) return current === void 0;
  return current === value;
}
const DEFAULT_SORT = { key: "manual", dir: "desc" };
const SORT_LABELS = {
  manual: "Board order",
  number: "Number",
  updated: "Updated",
...
function availableSortKeys(fields) {
  const keys = ["manual", "number", "updated", "created", "comments", "title"];
  if (fieldByName(fields, PRIORITY_FIELD)) keys.push("priority");
  if (fieldByName(fields, SIZE_FIELD)) keys.push("size");
  return keys;
}
function optionRank(item, field) {
...
function time(iso) {
  const t2 = iso ? Date.parse(iso) : NaN;
  return Number.isFinite(t2) ? t2 : 0;
}
function sortItems(items, sort, fields) {
  ...
  const compare = (a, b) => {
    ...
    switch (sort.key) {
      case "number":
        return (((_a = b.content) == null ? void 0 : _a.number) ?? 0) - (((_b = a.content) == null ? void 0 : _b.number) ?? 0);
      case "updated":
        return time((_c = b.content) == null ? void 0 : _c.updatedAt) - time((_d = a.content) == null ? void 0 : _d.updatedAt);
      case "created":
        return time((_e = b.content) == null ? void 0 : _e.createdAt) - time((_f = a.content) == null ? void 0 : _f.createdAt);
      case "comments":
        return (((_g = b.content) == null ? void 0 : _g.comments) ?? 0) - (((_h = a.content) == null ? void 0 : _h.comments) ?? 0);
      case "title":
...
const SuggestionsPanel = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-overlay", onClick: applying ? void 0 : onClose, role: "presentation" }, /* @__PURE__ */ React.createElement(
    "div",
    {
      className: "cpb-modal",
      onClick: (e) => e.stopPropagation(),
    ...
    ), /* @__PURE__ */ React.createElement("span", null, "Select all ", changes.length)), /* @__PURE__ */ React.createElement("div", { className: "cpb-suggest-list" }, changes.map((s) => {
      const now = current.get(s.itemId);
      return /* @__PURE__ */ React.createElement("label", { key: s.itemId, className: "cpb-suggest" }, /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "checkbox",
...
const Delta = ({ label, from, to }) => {
  if (from === to) return null;
  return /* @__PURE__ */ React.createElement("span", { className: "cpb-delta" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-delta-label" }, label), /* @__PURE__ */ React.createElement("span", { className: "cpb-delta-from" }, from ?? "unset"), /* @__PURE__ */ React.createElement("span", { className: "cpb-delta-arrow" }, "→"), /* @__PURE__ */ React.createElement("span", { className: "cpb-delta-to" }, to ?? "unset"));
};
function repositoriesOn(items) {
  var _a;
  const counts = /* @__PURE__ */ new Map();
  for (const item of items) {
    const repo = (_a = item.content) == null ? void 0 : _a.repository;
...
const NewIssueModal = ({
  ...
  const [status, setStatus] = React.useState(((_a = columns[0]) == null ? void 0 : _a.name) ?? "");
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-overlay", onClick: close, role: "presentation" }, /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-head" }, /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-titles" }, /* @__PURE__ */ React.createElement("h2", { className: "cpb-modal-title" }, "New issue"), /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-sub" }, "Opens it on GitHub and puts it on this board.")), /* @__PURE__ */ React.createElement("button", { className: "cpb-close", onClick: close, "aria-label": "Close" }, "✕")),
    /* @__PURE__ */ React.createElement("div", { className: "cpb-modal-scroll" }, error && /* @__PURE__ */ React.createElement("div", { className: "cpb-error", role: "alert" }, error), /* @__PURE__ */ React.createElement(
      "form",
      {
        className: "cpb-form",
        onSubmit: (e) => {
      ...
      /* @__PURE__ */ React.createElement("label", { className: "cpb-form-row" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-form-label" }, "Repository"), repos.length > 0 ? /* @__PURE__ */ React.createElement(
        "select",
        {
        ...
        repos.map((r2) => /* @__PURE__ */ React.createElement("option", { key: r2, value: r2 }, r2)),
        /* @__PURE__ */ React.createElement("option", { value: OTHER }, "Another repository…")
      ) : (
      ...
      repos.length > 0 && repoChoice === OTHER && /* @__PURE__ */ React.createElement("label", { className: "cpb-form-row" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-form-label" }), /* @__PURE__ */ React.createElement(
        "input",
        {
          className: "cpb-input cpb-form-control",
          value: typedRepo,
      ...
      /* @__PURE__ */ React.createElement("label", { className: "cpb-form-row" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-form-label" }, "Title"), /* @__PURE__ */ React.createElement(
        "input",
        {
          className: "cpb-input cpb-form-control",
          value: title,
      ...
      /* @__PURE__ */ React.createElement("label", { className: "cpb-form-row cpb-form-row--tall" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-form-label" }, "Description"), /* @__PURE__ */ React.createElement(
        "textarea",
        {
      ...
      columns.length > 0 && /* @__PURE__ */ React.createElement("label", { className: "cpb-form-row" }, /* @__PURE__ */ React.createElement("span", { className: "cpb-form-label" }, "Column"), /* @__PURE__ */ React.createElement(
        "select",
        {
          className: "cpb-select cpb-form-control",
          value: status,
        ...
        columns.map((c) => /* @__PURE__ */ React.createElement("option", { key: c.id, value: c.name }, c.name)),
        /* @__PURE__ */ React.createElement("option", { value: "" }, "No Status")
      )),
      /* @__PURE__ */ React.createElement("div", { className: "cpb-form-actions" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cpb-btn", onClick: close, disabled: submitting }, "Cancel"), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "cpb-btn cpb-btn--primary", disabled: !canSubmit }, submitting ? "Opening…" : "Create issue"))
    ))
  ));
};
const REFRESH_INTERVAL_MS = 3e4;
function canRefresh(gate) {
  return !(gate.writesPending || gate.dragging || gate.overlayOpen || gate.working || gate.hidden || gate.loading);
}
function agoLabel(since, now) {
...
const App = () => {
  ...
  const load = React.useCallback(
    async (fresh, quiet = false) => {
      ...
      try {
        ...
        setError(e.message || "Could not reach the plugin backend.");
      } finally {
  ...
  React.useEffect(() => {
    const t2 = setInterval(() => setNow(Date.now()), 1e4);
  ...
  const saveSettings = async (input) => {
    ...
    setSettingsError("");
    try {
      const res = await api.rpc("POST", `/config?path=${encodeURIComponent(projectPath)}`, input);
      if (res.error) {
  ...
  const applyField = React.useCallback(
    async (itemId, fieldName, optionName2) => {
      var _a;
      ...
      const nextOptionId = optionName2 ? (_a = field.options.find((o) => o.name.toLowerCase() === optionName2.toLowerCase())) == null ? void 0 : _a.id : void 0;
      const patch = (optionId) => setBoard(
        (b) => b ? {
          ...b,
          items: b.items.map((i) => {
      ...
      setError("");
      patch(nextOptionId);
      setPending((p2) => new Set(p2).add(itemId));
      try {
        ...
        patch(previous);
        setError(e.message || `Could not update ${fieldName}.`);
      } finally {
        setPending((p2) => {
  ...
  const onMove = React.useCallback(
    (itemId, toColumnId) => {
      ...
      const option = status == null ? void 0 : status.options.find((o) => o.id === toColumnId);
  ...
  const filtered = React.useMemo(() => {
    ...
    return board.items.filter(
      (i) => itemMatches(i, search) && passesFilter(i.singleSelect, priorityField, filters.priority) && passesFilter(i.singleSelect, sizeField, filters.size)
    );
  ...
  const prioritize = React.useCallback(async () => {
    ...
    try {
      ...
      const nameOf = (item, f) => {
        var _a;
        return f ? ((_a = f.options.find((o) => o.id === item.singleSelect[f.id])) == null ? void 0 : _a.name) ?? null : null;
      };
  ...
  const createIssue = React.useCallback(
    async (input) => {
      ...
      try {
        ...
        const columnId = columnIdFor(res.item, (statusField == null ? void 0 : statusField.id) ?? null);
        const columnCollapsed = collapsed.has(columnId);
        const passes = itemMatches(res.item, search) && passesFilter(res.item.singleSelect, board ? fieldByName(board.fields, PRIORITY_FIELD) : null, filters.priority) && passesFilter(res.item.singleSelect, board ? fieldByName(board.fields, SIZE_FIELD) : null, filters.size);
        const hidden = !passes || columnCollapsed;
        setNotice({
          text: hidden ? `Opened #${res.issue.number} — ${res.issue.title}. It is on the board, but the current view is hiding it.` : `Opened #${res.issue.number} — ${res.issue.title}`,
          url: res.issue.url,
          hidden,
          revealColumnId: columnCollapsed ? columnId : void 0
        });
  ...
  const currentValues = React.useMemo(() => {
    ...
    const map = /* @__PURE__ */ new Map();
    if (!board) return map;
    const p2 = fieldByName(board.fields, PRIORITY_FIELD);
    const z2 = fieldByName(board.fields, SIZE_FIELD);
    for (const item of board.items) {
      map.set(item.id, {
        priority: p2 ? ((_a = p2.options.find((o) => o.id === item.singleSelect[p2.id])) == null ? void 0 : _a.name) ?? null : null,
        size: z2 ? ((_b = z2.options.find((o) => o.id === item.singleSelect[z2.id])) == null ? void 0 : _b.name) ?? null : null
      });
    }
    return map;
  }, [board]);
  const selected = (board == null ? void 0 : board.items.find((i) => i.id === selectedId)) ?? null;
  const columnCount = board ? columnsFrom(board.fields).length : 0;
  return /* @__PURE__ */ React.createElement("div", { className: `cpb-root cpb-root--${theme}` }, /* @__PURE__ */ React.createElement("header", { className: "cpb-bar" }, /* @__PURE__ */ React.createElement("div", { className: "cpb-bar-left" }, /* @__PURE__ */ React.createElement("h1", { className: "cpb-h1" }, (board == null ? void 0 : board.title) ?? "Project Board"), board && /* @__PURE__ */ React.createElement("span", { className: "cpb-count" }, filtered.length, filtered.length !== board.items.length ? ` of ${board.items.length}` : "", " item", board.items.length === 1 ? "" : "s", " · ", columnCount, " columns", loadedAt !== null && /* @__PURE__ */ React.createElement("span", { className: "cpb-updated" }, " · updated ", agoLabel(loadedAt, now)))), /* @__PURE__ */ React.createElement("div", { className: "cpb-bar-right" }, /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  ), board && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    availableSortKeys(board.fields).map((k) => /* @__PURE__ */ React.createElement("option", { key: k, value: k }, SORT_LABELS[k]))
  ), sort.key !== "manual" && /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "cpb-btn cpb-icon-btn",
  ...
  )), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn", onClick: () => void load(true), disabled: loading }, loading ? "Loading…" : "Refresh"), board && /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "cpb-btn cpb-btn--primary",
      onClick: () => {
    ...
    "New issue"
  ), board && /* @__PURE__ */ React.createElement(
    "a",
    {
      className: "cpb-btn cpb-icon-btn",
      href: board.url,
    ...
    /* @__PURE__ */ React.createElement(GitHubMark, null)
  ), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn", onClick: () => void openSettings(), "aria-label": "Board settings" }, "⚙"))), board && /* @__PURE__ */ React.createElement(FilterBar, { fields: board.fields, filters, onChange: setFilters }), error && /* @__PURE__ */ React.createElement("div", { className: "cpb-error cpb-error--bar", role: "alert" }, /* @__PURE__ */ React.createElement("span", null, error), /* @__PURE__ */ React.createElement("button", { className: "cpb-error-dismiss", onClick: () => setError(""), "aria-label": "Dismiss" }, "✕")), notice && /* @__PURE__ */ React.createElement("div", { className: "cpb-notice cpb-error--bar", role: "status" }, /* @__PURE__ */ React.createElement("span", null, notice.text, " ", notice.hidden && /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      onClick: () => {
        ...
        setNotice({ ...notice, hidden: false, revealColumnId: void 0, text: notice.text.split(".")[0] });
      }
    },
    "Show it"
  ), " ", /* @__PURE__ */ React.createElement("a", { href: notice.url, target: "_blank", rel: "noreferrer noopener" }, "Open on GitHub")), /* @__PURE__ */ React.createElement("button", { className: "cpb-error-dismiss", onClick: () => setNotice(null), "aria-label": "Dismiss" }, "✕")), notConfigured ? /* @__PURE__ */ React.createElement("div", { className: "cpb-setup" }, /* @__PURE__ */ React.createElement("h2", { className: "cpb-setup-title" }, "No board yet"), /* @__PURE__ */ React.createElement("p", { className: "cpb-setup-body" }, notConfigured), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn cpb-btn--primary", onClick: () => void openSettings() }, "Set up the board")) : loading && !board ? /* @__PURE__ */ React.createElement("div", { className: "cpb-setup" }, /* @__PURE__ */ React.createElement("p", { className: "cpb-setup-body" }, "Loading the board…")) : board ? /* @__PURE__ */ React.createElement(
    Board,
    {
      board,
      items: sorted,
  ...
  ) : null, selected && board && /* @__PURE__ */ React.createElement(
    ItemModal,
    {
      item: selected,
      fields: board.fields,
      ...
      error,
      projectPath,
      onSetField: (fieldName, optionName2) => void applyField(selected.id, fieldName, optionName2),
      onClose: () => setSelectedId(null)
    }
  ), suggestions && /* @__PURE__ */ React.createElement(
    SuggestionsPanel,
    {
      result: suggestions,
      ...
      onToggleAll: (on) => setPicked(
        on ? new Set(
          suggestions.suggestions.filter((s) => {
            const now2 = currentValues.get(s.itemId);
            return !now2 || now2.priority !== s.priority || now2.size !== s.size;
          }).map((s) => s.itemId)
        ) : /* @__PURE__ */ new Set()
      ),
  ...
  ), newIssue && board && /* @__PURE__ */ React.createElement(
    NewIssueModal,
    {
      items: board.items,
      fields: board.fields,
      owner: (settings == null ? void 0 : settings.owner) ?? "",
      submitting: creating,
      error: createError,
...
function mount(container, api) {
  ...
  root.render(
    /* @__PURE__ */ React.createElement(PluginProvider, { api }, /* @__PURE__ */ React.createElement(App, null))
  );
}
