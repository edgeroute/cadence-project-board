...
const SettingsModal = ({ initial, saving, error, onSave, onClose }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cpb-overlay", onClick: onClose, role: "presentation" }, /* @__PURE__ */ React.createElement(
    ...
    ), /* @__PURE__ */ React.createElement("button", { className: "cpb-btn cpb-paste", onClick: () => void pasteFromClipboard(setToken, { detectUrl: false }), title: "Paste from clipboard" }, "Paste")), /* @__PURE__ */ React.createElement("div", { className: "cpb-hint" }, "Must be a ", /* @__PURE__ */ React.createElement("strong", null, "classic"), " token with ", /* @__PURE__ */ React.createElement("code", null, "repo"), " and ", /* @__PURE__ */ React.createElement("code", null, "project"), " scopes. Fine-grained tokens cannot read user-owned projects at all."), /* @__PURE__ */ React.createElement("div", { className: "cpb-hint" }, "It is written to ", /* @__PURE__ */ React.createElement("code", null, ".CadenceBoard/project-board.json"), " in this project, and that directory is added to ", /* @__PURE__ */ React.createElement("code", null, ".gitignore"), "."), /* @__PURE__ */ React.createElement("div", { className: "cpb-actions" }, /* @__PURE__ */ React.createElement("button", { className: "cpb-btn", onClick: onClose, disabled: saving }, "Cancel"), /* @__PURE__ */ React.createElement(
      "button",
      {
